"""Level: Medium
Two chances to guess correct number.
"""
import csv
...
def medm():
    ...
    while chk=="T":
        ...
        if ent==num:
            ...
            chc=int(input("Wrong Choice!!(Last Chance) Enter another number:"))
            if chc==num:
                tscor+=100
                print("Right! Score till now:",tscor)
...
def savescr(scor):
    file=open("comMedmMode.csv","a",newline="")
    ...
    file=open("comMedmMode.csv","w",newline="")
...
def scoreread():
    ...
    file=open("comMedmMode.csv","r",newline="")
